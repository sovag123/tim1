...
@section('content')
     ...
     <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="scroll height-content section-content">
                <form method="post" action="{{route('ucenik.store')}}" enctype="multipart/form-data" class="text-gray-700 text-[14px] forma">
                   @csrf 
                   @method('POST')
                            ...
                            <label class="mt-6 cursor-pointer">
                                <div id="empty-cover-art" class="relative w-48 h-48 py-[48px] text-center border-2 border-gray-300 border-solid">
                                    <div class="py-4">
                                        ...
                                        <input type='file' class="hidden"  name="image" :accept="accept" onchange="loadFileStudent(event)" />
                                    </div>

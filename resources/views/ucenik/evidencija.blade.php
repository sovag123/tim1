                    ...
                    <span
                        ...
                        <div
                            class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer">
                                <a href="{{route('ucenik.evidencijarez',$ucenik)}}" aria-label="Izdate knjige"
                                class="flex items-center">
                                <i
            ...
            <li class="mb-[4px]">
                <div class="w-[300px] pl-[28px]">
                    <span
                        ...
                        <div
                            class="group hover:bg-[#EFF3F6] py-[15px] px-[20px] w-[268px] rounded-[10px] cursor-pointer">
                            <a href="{{route('evidencija.store')}}" aria-label="Knjige na raspolaganju"
                                class="flex items-center">
                                <i
        ...
        <table class="w-full shadow-lg" id="myTable">
            ...
            <tbody class="bg-white">
                ...
                <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                    ...
                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{$niz[3]}}</td>
                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{$niz[4]}}</td>
                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                        <div>
                            <span>@if(floor($niz[5] / 7) == 0)
                                {{$niz[5]}} dana 
                                @else
                                {{ (int) floor($niz[5] / 7) }} nedelje
                                @if($niz[5]%7!=0)
                                i
                                {{ $niz[5]%7 }} dana
                                @endif
                    ...
                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{$niz[2]}}
                    </td>

                                ...
                                <tr class="border-b-[1px] border-[#e4dfdf]">
                                                    ...
                                                    <li class="flex p-2 mt-[2px] pt-[15px] group hover:bg-gray-200">
                                                        <label class="flex items-center justify-start">
                                                            <div
                                                                ...
                                                                <form action=" {{ route('knjiga.filteri') }} " method="POST">
                                                                    @csrf
                                                                <input type="checkbox" name="check_box[]" value="{{ $autor->id }}" id="{{ $autor->id }}">
                                   ...
                                   {{$autor->ImePrezime}}
                                            ...
                                            <div class="flex pt-[10px] text-white ">
                                                <input type="submit" value="Sacuvaj" class="py-2 px-[20px] transition duration-300 ease-in hover:bg-[#46A149] bg-[#4CAF50] rounded-[5px]">
                                        ...
                                        <div
                                            ...
                                            <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                                ...
                                                <div class="py-1">
                                                    ...
                                                    <a href="{{route('knjiga.otpisi',$knjiga)}}" tabindex="0"
                                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                        role="menuitem">
